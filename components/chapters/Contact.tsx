    ...
    <ChapterSection id="contact" aria-label="Contact" className="flex items-center justify-center px-4">
      <div className="text-center max-w-2xl mx-auto">
        ...
        <ScrollReveal delay={400}>
          <p className="text-xl md:text-2xl font-semibold text-slate-800 mb-2">
            {fullName}
          </p>
            ...
            {socialLinks.map((link) => {
              ...
              return (
                <a
                  ...
                  className="inline-flex items-center justify-center min-h-11 min-w-11 p-3 rounded-full border border-slate-200 text-slate-500 hover:text-cyan-700 hover:border-cyan-300 hover:bg-cyan-50 transition-colors duration-200 cursor-pointer"
                >
        ...
        <ScrollReveal delay={600}>
          <a
            ...
            className="inline-flex items-center justify-center min-h-11 min-w-11 px-8 py-3 rounded-full bg-slate-900 text-white font-semibold text-lg hover:bg-slate-800 transition-colors duration-200 cursor-pointer"
          >
            Get in Touch
          </a>
        </ScrollReveal>
